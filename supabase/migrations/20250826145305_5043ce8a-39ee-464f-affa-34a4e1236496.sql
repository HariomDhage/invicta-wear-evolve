...
-- Create policies for newsletter signups (allow anyone to insert, only admins to read)
...
-- Create policies for contact messages (allow anyone to insert, only admins to read)
