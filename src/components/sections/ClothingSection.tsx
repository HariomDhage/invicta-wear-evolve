    ...
    <section className="py-20 bg-background">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16">
          <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-serif mb-4">
          ...
          <div className="group relative overflow-hidden rounded-2xl aspect-[3/4] sm:aspect-[4/5] cursor-pointer transform transition-all duration-500 hover:scale-105">
            ...
            <div className="relative h-full flex flex-col justify-end p-4 sm:p-6 md:p-8 text-white">
              <div className="transform transition-transform duration-500 group-hover:translate-y-0 translate-y-4">
                ...
                <h3 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-2">WOMEN'S</h3>
                <p className="text-sm sm:text-base md:text-lg opacity-90 mb-4">Engineered for female athletes who break barriers</p>
          ...
          <div className="group relative overflow-hidden rounded-2xl aspect-[3/4] sm:aspect-[4/5] cursor-pointer transform transition-all duration-500 hover:scale-105">
            ...
            <div className="relative h-full flex flex-col justify-end p-4 sm:p-6 md:p-8 text-white">
              <div className="transform transition-transform duration-500 group-hover:translate-y-0 translate-y-4">
                ...
                <h3 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-2">MEN'S</h3>
                <p className="text-sm sm:text-base md:text-lg opacity-90 mb-4">Built for strength, designed for victory</p>
                <div className="flex items-center text-sm font-semibold">
                  <span>SHOP NOW</span>
                  <div className="ml-2 w-6 h-px bg-white transform transition-all duration-300 group-hover:w-8" />
                </div>
