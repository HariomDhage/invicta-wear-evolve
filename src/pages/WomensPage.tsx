      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          <h1 className="text-4xl font-bold mb-4">
            WOMEN'S <span className="text-primary">COLLECTION</span>
          </h1>
          <p className="text-muted-foreground text-lg">
            Discover our complete women's activewear collection
          </p>
        </div>
            ...
            {products.length === 0 && (
              <div className="text-center py-12">
                ...
                <Button
                  variant="outline"
                  className="mt-4"
                  onClick={() => setFilters({ category: 'all', gender: 'women', priceRange: [0, 200], search: '' })}
                >
                  Clear Filters
                </Button>
              </div>
